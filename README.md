...
| Project | Description |
|:--------|:------------|
| [`sage`](https://github.com/majiayu000/sage) | Code agent in pure Rust |
| [`litellm-rs`](https://github.com/majiayu000/litellm-rs) | AI Gateway with OpenAI-compatible APIs |
...
```
┌──────────────────────────────────────┐
│  BLOG: silencestar.com               │
│  MAIL: mylifcc@gmail.com             │
└──────────────────────────────────────┘
```
